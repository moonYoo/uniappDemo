<template>
  <view class="content">
    <view>
      ...
      <navigator url="../test2/test2?from=test"
                 hover-class="navigator-hover">
        <button type="default">跳转到test2页面</button>
      </navigator>
      <navigator url="../index/index?from=test"
                 open-type="redirect"
                 hover-class="navigator-hover">
        <button type="default">跳转到index页面</button>
      </navigator>
    </view>
  </view>
</template>
